  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-warm": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 100%)",
        "gradient-hero": "radial-gradient(ellipse 80% 50% at 50% -20%, hsl(var(--primary) / 0.4) 0%, transparent 60%)",
      },
      boxShadow: {
        glow: "0 0 40px hsl(var(--primary) / 0.3)",
        "glow-lg": "0 0 60px hsl(var(--primary) / 0.4)",
        warm: "0 8px 32px hsl(0 0% 0% / 0.4)",
      },
    },
  },
